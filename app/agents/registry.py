...
def _contract(
    ...
    *,
    ...
    required_permission_refs: tuple[str, ...] = ("api.meta.read",),
    ...
    return AgentTaskContract(
        ...
        required_permission_refs=required_permission_refs,
...
def get_agent_task_registry() -> dict[str, AgentTaskContract]:
    ...
    contracts = [
        _contract(
            ...
            required_permission_refs=("api.meta.read", "api.review_queue.read"),
        ...
        _contract(
            ...
            required_permission_refs=("api.meta.read", "api.listing_analyses.read"),
            legacy_compatibility=True,
        ),
        _contract(
            "market_research",
        ...
        _contract(
            ...
            "evidence_candidates",
            handlers,
            description="PR41 internal-only evidence candidate collection from existing listing context.",
            side_effects=(AgentSideEffect.WRITE_AGENT_TASK_RESULT, AgentSideEffect.WRITE_AGENT_ARTIFACT_FUTURE),
            limitations=("internal_evidence_candidates_only", "no_external_http", "no_llm", "no_rag_write", "not_normalized_evidence", "not_market_evidence_item"),
        ),
        _contract(
            ...
            "normalized_evidence",
            handlers,
            description="PR42 internal-only normalization of PR41 evidence_candidates artifacts into normalized_evidence artifacts.",
            side_effects=(AgentSideEffect.WRITE_AGENT_TASK_RESULT, AgentSideEffect.WRITE_AGENT_ARTIFACT_FUTURE),
            limitations=(
                "internal_normalization_only",
                "input_artifact_type_evidence_candidates",
                "output_artifact_type_normalized_evidence",
                "normalization_kind_normalized_evidence_candidates",
                "no_market_evidence_write",
                "no_scoring_write",
                "no_external_http",
                "no_llm",
                "no_rag_write",
