...
from sqlalchemy import Boolean, CheckConstraint, DateTime, Integer, JSON, String, Text, func, text
...
class KnowledgeNote(Base):
    ...
    profile: Mapped[str] = mapped_column(String(128), default="global", server_default="global", index=True)
    title: Mapped[str] = mapped_column(String(200))
    body_md: Mapped[str] = mapped_column(Text)
    tags_json: Mapped[list[str]] = mapped_column(JSON, default=list, server_default=text("'[]'"))
