...
class GoogleSheetsWebhookNotifier:
    ...
    async def send_listing_alert(self, message: str, payload: dict) -> bool:
        ...
        outbound = {
            ...
            "analysis_verdict": payload.get("analysis_verdict"),
            "analysis_version": payload.get("analysis_version"),
            "analysis_input_hash": payload.get("analysis_input_hash"),
            "analysis_context_key": payload.get("analysis_context_key"),
            "analysis_risk_flags": payload.get("analysis_risk_flags"),
            "analysis_questions": payload.get("analysis_questions"),
            "analysis_report_md": payload.get("analysis_report_md"),
            "analysis_config_hash": payload.get("analysis_config_hash"),
            "analysis_config": payload.get("analysis_config"),
            "analysis_price_per_m2": payload.get("analysis_price_per_m2"),
            "analysis_facts_compact": payload.get("analysis_facts_compact"),
