...
def test_decision_source_workflow_and_no_side_effects(monkeypatch):
    ...
    for forbidden in ["primary_recommendation", "recommendation", "headline", "top_reasons", "top_risks", "next_steps", "missing_data", "readiness", "risk_severity", "risk_visual", "facts_json", "result_json", "payload_json", "risks_json", "questions_json", "report_md"]:
