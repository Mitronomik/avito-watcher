...
def test_fetch_item_details_extracts_sanitized_fields(monkeypatch):
    ...
    assert details["seller_profile_url"] == "https://www.avito.ru/user/u1"


def test_fetch_item_details_accepts_absolute_avito_seller_profile_url(monkeypatch):
    parser = AvitoParser()
    html = """
    <html><body>
      <div data-marker="item-view/item-date">17 мая в 12:01</div>
      <a data-marker="seller-info/name" href="https://www.avito.ru/user/u1">seller</a>
    </body></html>
    """
...
def test_fetch_item_details_ignores_external_seller_profile_url(monkeypatch):
    parser = AvitoParser()
    html = """
    <html><body>
      <div data-marker="item-view/item-date">17 мая в 12:01</div>
      <a data-marker="seller-info/name" href="https://example.com/u1">seller</a>
    </body></html>
    """
...
def test_fetch_item_details_rejects_javascript_seller_profile_url(monkeypatch):
    parser = AvitoParser()
    html = """
    <html><body>
      <div data-marker="item-view/item-date">17 мая в 12:01</div>
      <a data-marker="seller-info/name" href="javascript:alert(1)">seller</a>
    </body></html>
    """
...
def test_fetch_item_details_rejects_mailto_seller_profile_url(monkeypatch):
    parser = AvitoParser()
    html = """
    <html><body>
      <div data-marker="item-view/item-date">17 мая в 12:01</div>
      <a data-marker="seller-info/name" href="mailto:test@example.com">seller</a>
    </body></html>
    """
