# Human outcome analytics / backtesting read model (PR18b)
...
PR18b implements the human outcome analytics / backtesting read model. The Admin UI for searches, analyses, agents, evidence, and reviews remains future scope, and the PR35 Backtesting dashboard also remains future scope.
